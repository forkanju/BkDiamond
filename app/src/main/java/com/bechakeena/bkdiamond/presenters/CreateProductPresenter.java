...
public class CreateProductPresenter {
    ...
    public CreateProductPresenter(CommonView view) {
    ...
    public void createProduct(String token, String supplierId, String product, String quantity,String price,String unitId, int categoryId) {
        Map<String, String> map = new HashMap<>();
        map.put("Content-Type", "application/json");
        map.put("Authorization", token);

        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("productName", product);
