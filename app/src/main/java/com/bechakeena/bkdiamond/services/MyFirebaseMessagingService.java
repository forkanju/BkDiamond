...
import com.bechakeena.bkdiamond.activities.MainActivity;
import com.bechakeena.bkdiamond.activities.NotificationActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onNewToken(@NonNull String token) {
        SharedDataSaveLoad.save(this, getString(R.string.preference_fcm_token), token);
    }
    public void showNotification(String title, String message) {
        AppDatabase.saveNotification(new Notification(System.currentTimeMillis(), title, message));
