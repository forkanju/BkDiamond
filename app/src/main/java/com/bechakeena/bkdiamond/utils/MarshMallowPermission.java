...
public class MarshMallowPermission {
    ...
    public static final int PERMISSIONS_REQUEST_READ_PHONE = 5;
    Activity activity;
    ...
    public void requestPermissionForReadPhone(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.READ_PHONE_STATE)||
                ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.READ_PHONE_STATE)){
            ActivityCompat.requestPermissions(activity, new String[]{Manifest.permission.READ_PHONE_STATE,Manifest.permission.READ_PHONE_STATE}, PERMISSIONS_REQUEST_READ_PHONE);
